...
char str6[]="DHRUV VARSHNEY";
char str7[]="1BI18CS050";
char str8[]="DEPT OF CSE,SEC A";
char str9[]="PROJECT GUIDED BY :";
char str10[]="DR.GIRIJA";
char str11[]="ASSOCIATE PROFESSOR ";
char str12[]="DEPT OF COMPUTER SCIENCE & ENGG";
char str13[]="PRESS R TO CONTINUE";
char str14[]="";
char str15[]="PRESS t/T TO ";
GLint angle;
void menufunc(int n)
{
switch(n)
...
case 3: glutFullScreen();
break;
case 4: glutReshapeWindow(1200,800);
break;
}
}
void rotate()
...
void loadIntro(void)        //added
{
    ...
    unsigned char *data = stbi_load("front.png", &width,
...
void last_fly(unsigned char key,int x,int y)
{
	...
	glutAddMenuEntry("fullscreen",3);
	glutAddMenuEntry("Exit FullScreen",4);
...
char str[]="THERE LIVED A GROUP OF PEGION WITH A RAT AS A FRIENDS";
...
char str[]="ONE DAY THE GROUP OF PEGION GOT TRAPPED WHILE EATING GRAIN";
glColor3f(0,0,0);
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
...
if(display_order==3)
{
char str[]="THEY SHOW THE UNITY AND CARRY THE NET ALONG WITH THEM";
glColor3f(0,0,0);
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
...
if(display_order==6)
{
char str[]="RAT CUT THE NET AND SHOW THE FRIENDSHIP";
glColor3f(0,0,0);
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
...
if(display_order==7)
{
char str[]="GROUP OF PIGEONS THANKS RAT";
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
			glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str[i]);
...
if(display_order==8)
{
char str[]="THE GROUP OF PEGIONS FLEW AWAY";
glColor3f(0,0,0);
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
...
char str[]="THEY FLEW TOWARDS THE NEARBY TOWN WHERE RAT WAS THERE";
glColor3f(0,0,0);
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
...
char str[]="THEY REACH RAT TO GET RID OF THE NET";
glColor3f(0,0,0);
glRasterPos2f(30,5);
		for(i=0;i<strlen(str);i++)
		{
...
int main(int argc,char **argv)
{
	...
	glutInitWindowPosition(1440,900);
